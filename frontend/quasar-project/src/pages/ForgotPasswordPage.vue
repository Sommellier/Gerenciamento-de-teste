      ...
      <div class="col-12 col-md-6 q-pa-none hidden-sm-down">
        <div class="image-container">
          ...
          <div class="welcome-text">
            <h2 class="welcome-title">Esqueceu sua senha?</h2>
            <p class="welcome-subtitle">Não se preocupe, vamos te ajudar a recuperar o acesso</p>
          </div>
        </div>
      </div>

      <!-- Formulário de recuperação -->
      <div class="col-12 col-md-6 flex flex-center forgot-form-container">
        <div class="forgot-card">
          ...
          <q-form @submit.prevent="handleReset" class="forgot-form">
            ...
            <div class="login-section">
              <span class="login-text">Lembrou da sua senha?</span>
              <q-btn 
                flat 
                label="Fazer login" 
                color="primary" 
