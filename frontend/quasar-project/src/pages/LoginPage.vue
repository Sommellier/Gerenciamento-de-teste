        ...
        <q-card flat class="q-pa-xl q-mx-auto q-mt-xl bg-white"
          ...
          <q-form @submit.prevent="handleLogin">
            ...
            <q-input v-model="password" label="Password" :type="showPassword ? 'text' : 'password'" filled dense rounded
              color="primary" class="q-mb-md" :rules="[val => !!val || 'Senha é obrigatória']">
            ...
            <q-checkbox v-model="rememberMe" label="Remember me" dense class="q-mb-lg" color="primary" />

            <q-btn type="submit" label="Log in" color="primary" class="full-width q-mb-md" unelevated rounded no-caps
              size="lg" />

            <div class="text-center q-mb-md">
              <q-btn flat label="Forgot Password?" color="primary" class="q-pa-none" @click="forgotPassword" />
            </div>
            ...
            <div class="text-center q-mt-md text-caption">
              ...
              <q-btn flat label="Sign up" color="primary" class="q-pa-none" @click="signUp" />
            </div>
          </q-form>
        </q-card>
      </div>
...
async function forgotPassword() { await router.push('/forgot-password') }
async function signUp() { await router.push('/register') }
</script>
