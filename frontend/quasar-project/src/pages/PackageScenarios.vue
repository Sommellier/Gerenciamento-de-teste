<template>
  <q-page class="modern-package-scenarios">
    <!-- Animated Background -->
    ...
    <div class="main-container">
      ...
      <div class="page-header">
        <div class="header-left">
          ...
          <div class="header-info">
            <h1 class="page-title">Cenários de Teste</h1>
            <p class="page-subtitle">Gerencie os cenários de teste do pacote</p>
          </div>
        </div>
      </div>
      ...
      <div class="content-section">
        ...
        <div class="create-scenario-card">
          <div class="card-header">
            <div class="header-icon">
              <q-icon name="add_task" size="32px" />
            </div>
            <div class="header-content">
              <h2 class="card-title">Criar Novo Cenário</h2>
...
// Real members data from project
...
async function createScenario() {
  try {
    ...
    // Chamar a API para criar o cenário
    await scenarioService.createScenario(packageId.value, scenarioData)
    
    // Mostrar diálogo de sucesso
    showSuccessDialog.value = true
    
    // Limpar formulário
    scenarioForm.value = { name: '', description: '', tester: null, approver: null, type: null, priority: null }
