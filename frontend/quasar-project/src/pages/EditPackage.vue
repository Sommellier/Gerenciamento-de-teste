      ...
      <div class="header-content">
        <div class="title-section">
          <q-btn
            ...
            color="primary"
          />
          <q-icon name="edit" class="section-icon" />
          <h1 class="page-title">Editar Pacote de Teste</h1>
        </div>
        <div class="subtitle">Edite as informações do pacote de teste</div>
      </div>
    </div>

    <q-card class="form-card" v-if="!loading">
      <q-form @submit="onSubmit" class="package-form">
        <q-card-section class="form-section">
          ...
          <!-- Status do Pacote -->
          <div class="form-group">
            <h3 class="group-title">Status do Pacote</h3>
            <div class="form-row">
              <q-select
                v-model="form.status"
